 ...
 * 
 *  Accela Automation
 *  File: BookTicketClientHandler.java
 * 
 *  Accela, Inc.
 *  Copyright (C): 2015
 * 
 *  Description:
 *  http://my.oschina.net/imhoodoo/blog/361076
 * 
 *  Notes:
 * 	$Id: BookTicketClientHandler.java 72642 2009-01-01 20:01:57Z ACHIEVO\galen.zhang $ 
 * 
 *  Revision History
 *  &lt;Date&gt;,			&lt;Who&gt;,			&lt;What&gt;
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception
	{
		...
		switch (responseMsg.getCode())
		{
			case Code.CODE_SEARCH:// 收到查询结果
				System.out.println("==========火车【" + responseMsg.getTrain().getNumber() + "】余票查询结果:【"
						+ (responseMsg.isSuccess() ? "成功" : "失败") + "】=========");
			...
			case Code.CODE_BOOK:// 收到订票结果
				System.out.println("==========火车【" + responseMsg.getTrain().getNumber() + "】订票结果:【"
						+ (responseMsg.isSuccess() ? "成功" : "失败") + "】=========");
				System.out.println(responseMsg.getMsg());
