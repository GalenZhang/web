...
import com.achievo.sample.chapter1.lucene.score.payload.BoldAnalyzer;

/**
 * <pre>
 * 
 *  Accela Automation
 *  File: AnalyzerUtils.java
 * 
 *  Accela, Inc.
 *  Copyright (C): 2015
 * 
 ...
 * 
 *  Notes:
 * 	$Id: AnalyzerUtils.java 72642 2009-01-01 20:01:57Z ACHIEVO\galen.zhang $ 
 * 
 *  Revision History
 *  &lt;Date&gt;,			&lt;Who&gt;,			&lt;What&gt;
 ...
 */
/**
 * 用于分词器测试的一个简单工具类(用于打印分词情况，包括Term的起始位置和结束位置(即所谓的偏移量)， 位置增量，Term字符串，Term字符串类型(字符串/阿拉伯数字之类的))
 * 
 * @author Lanxiaowei
 *
 */
