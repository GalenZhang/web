package com.achievo.sample.chapter1.lucene.mmseg4j;
 ...
 * 
 *  Notes:
 * 	$Id: MMSegAnalyzerTest.java 72642 2009-01-01 20:01:57Z ACHIEVO\galen.zhang $ 
 * 
 *  Revision History
 *  &lt;Date&gt;,			&lt;Who&gt;,			&lt;What&gt;
...
public class MMSegAnalyzerTest
{
	...
	/*
	 * @Test public void testCutLeeterDigitFilter() { String myTxt = "mb991ch cq40-519tx mmseg4j "; List<String> words =
	 * toWords(myTxt, new MMSegAnalyzer("") {
	 * 
	 * @Override protected TokenStreamComponents createComponents(String text) { Reader reader = new BufferedReader(new
	 * StringReader(text)); Tokenizer t = new MMSegTokenizer(newSeg(), reader); return new TokenStreamComponents(t, new
	 * CutLetterDigitFilter(t)); }
	 * 
	 * 
	 * });
	 * 
	 * //Assert.assertArrayEquals("CutLeeterDigitFilter fail", words.toArray(new String[words.size()]),
	 * "mb 991 ch cq 40 519 tx mmseg 4 j".split(" ")); for(String word : words) { System.out.println(word); } }
	 */
